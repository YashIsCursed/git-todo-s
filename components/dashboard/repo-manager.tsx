...
export default function RepoManager({
  ...
  const handleFileClick = async (node: FileNode) => {
    ...
    setShowGraph(false); // Auto switch to code view
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] w-full overflow-hidden bg-background">
      ...
      <div className="flex-1 flex overflow-hidden">
              ...
              <>
                ...
                <ScrollArea className="flex-1 w-full h-full">
                  {isLoading ? (
                    ...
                    <div className="p-4">
                      <pre className="text-xs font-mono tab-4 overflow-x-auto whitespace-pre">
                ...
                <div className="w-full max-w-2xl aspect-square max-h-[600px] relative">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart
                      ...
                      data={chartData}
                    >
                      <PolarGrid strokeClassName="stroke-muted-foreground/20" />
                      <PolarAngleAxis
                        dataKey="subject"
        ...
        {isRightSidebarOpen && (
          <div className="w-[400px] border-l bg-muted/10 flex flex-col shrink-0 transition-all">
            ...
            <ScrollArea className="flex-1 p-4">
              <div className="space-y-3">
                {todos.map((todo) => (
                  <div
                    key={todo.id}
                    className="group flex flex-col gap-2 p-3 rounded-lg border bg-card hover:shadow-md transition-all relative"
                  >
